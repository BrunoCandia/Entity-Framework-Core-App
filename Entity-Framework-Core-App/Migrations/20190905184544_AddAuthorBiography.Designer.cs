...
namespace Entity_Framework_Core_App.Migrations
{
    ...
    [Migration("20190905184544_AddAuthorBiography")]
            ...
            modelBuilder.Entity("Entity_Framework_Core_App.Models.AuthorBiography", b =>
                {
                    ...
                    b.HasIndex("AuthorFirstName", "AuthorLastName")
                        .IsUnique()
                        .HasFilter("[AuthorFirstName] IS NOT NULL AND [AuthorLastName] IS NOT NULL");
            ...
            modelBuilder.Entity("Entity_Framework_Core_App.Models.AuthorBiography", b =>
                {
                    b.HasOne("Entity_Framework_Core_App.Models.Author", "Author")
                        .WithOne("Biography")
                        .HasForeignKey("Entity_Framework_Core_App.Models.AuthorBiography", "AuthorFirstName", "AuthorLastName");
                });
